...
Example kubernetes files are available at ``scripts/ci/in_container/kubernetes/*.yaml`` in the source distribution (please note that these examples are not ideal for production environments).
